...
echo ""
echo "1. Teste ob Daten korrekt geladen werden:"
echo "   python scripts/load_blockchair_data.py \\"
echo "     --data-dir $OUTPUT_DIR/extracted \\"
echo "     --start-date 2021-01-01 \\"
echo "     --end-date 2021-01-01"
echo ""
echo "2. Öffne Jupyter Notebook:"
echo "   ./start_project.sh"
echo ""
echo "3. Öffne notebooks/02_local_data_exploration.ipynb"
echo "   und setze: BLOCKCHAIR_DATA_DIR = \"$OUTPUT_DIR/extracted\""
echo ""
